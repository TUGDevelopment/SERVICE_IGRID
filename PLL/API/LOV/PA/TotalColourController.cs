...
{
    public class TotalColourController : ApiController
    {
        [Route("api/lov/pa/totalcolour")]
            ...
            try
            {
                using (var context = new ARTWORKEntities())
                {
                    using (CNService.IsolationLevel(context))
                    {
                        ...
                        {
                            case "F":
                                param.data.NAME = "ZPKG_SEC_CAR_TOTAL_COLOUR";
                                break;
                            case "C":
                                param.data.NAME = "ZPKG_SEC_CARD_TOTAL_COLOUR";
                                break;
                            case "D":
                                param.data.NAME = "ZPKG_SEC_DISP_TOTAL_COLOUR";
                                break;
                            case "R":
                                param.data.NAME = "ZPKG_SEC_INN_NO_TOTAL_COLOUR";
                                break;
                            case "N":
                                param.data.NAME = "ZPKG_SEC_INNER_TOTAL_COLOUR";
                                break;
                            case "P":
                                param.data.NAME = "ZPKG_SEC_INST_TOTAL_COLOUR";
                                break;
                            case "K":
                                param.data.NAME = "ZPKG_SEC_LABE_TOTAL_COLOUR";
                                break;
                            case "L":
                                param.data.NAME = "ZPKG_SEC_LEA_TOTAL_COLOUR";
                                break;
                            case "H":
                                param.data.NAME = "ZPKG_SEC_SLEV_TOTAL_COLOUR";
                                break;
                            case "J":
                                param.data.NAME = "ZPKG_SEC_STKC_TOTAL_COLOUR";
                                break;
                            case "G":
                                param.data.NAME = "ZPKG_SEC_TRAY_TOTAL_COLOUR";
                                break;
                            case "M":
                                param.data.NAME = "ZPKG_SEC_PLAST_TOTAL_COLOUR";
                                break;
                            default:
