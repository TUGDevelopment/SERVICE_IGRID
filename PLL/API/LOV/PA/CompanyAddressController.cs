...
{
    public class CompanyAddressController : ApiController
    {
        [Route("api/lov/pa/companyaddress")]
        public SAP_M_CHARACTERISTIC_RESULT Get([FromUri]SAP_M_CHARACTERISTIC_REQUEST param)
        {
            return Helper.QueryByName("ZPKG_SEC_COMPANY_ADR", param);
            ...
            //    }
            //    param.data.NAME = "ZPKG_SEC_COMPANY_ADR";
