...
{
    public class CatchingMethodController : ApiController
    {
        [Route("api/lov/pa/catchingmethod")]
        public SAP_M_CHARACTERISTIC_RESULT Get([FromUri]SAP_M_CHARACTERISTIC_REQUEST param)
        {

            return Helper.QueryByName("ZPKG_SEC_CATCHING_METHOD", param);
            ...
            //    }
            //    param.data.NAME = "ZPKG_SEC_CATCHING_METHOD";
