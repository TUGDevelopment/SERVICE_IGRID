...
{
    public class ProcessColourController : ApiController
    {
        [Route("api/lov/pa/processcolour")]
            ...
            try
            {
                using (var context = new ARTWORKEntities())
                {
                    using (CNService.IsolationLevel(context))
                    {
                        ...
                        {
                            case "F":
                                param.data.NAME = "ZPKG_SEC_CAR_PROCESS_COLOUR";
                                break;
                            case "C":
                                param.data.NAME = "ZPKG_SEC_CARD_PROCESS_COLOUR";
                                break;
                            case "D":
                                param.data.NAME = "ZPKG_SEC_DISP_PROCESS_COLOUR";
                                break;
                            case "R":
                                param.data.NAME = "ZPKG_SEC_INN_NO_PROCESS_COLOUR";
                                break;
                            case "N":
                                param.data.NAME = "ZPKG_SEC_INNER_PROCESS_COLOUR";
                                break;
                            case "P":
                                param.data.NAME = "ZPKG_SEC_INST_PROCESS_COLOUR";
                                break;
                            case "K":
                                param.data.NAME = "ZPKG_SEC_LABE_PROCESS_COLOUR";
                                break;
                            case "L":
                                param.data.NAME = "ZPKG_SEC_LEA_PROCESS_COLOUR";
                                break;
                            case "H":
                                param.data.NAME = "ZPKG_SEC_SLEV_PROCESS_COLOUR";
                                break;
                            case "J":
                                param.data.NAME = "ZPKG_SEC_STKC_PROCESS_COLOUR";
                                break;
                            case "G":
                                param.data.NAME = "ZPKG_SEC_TRAY_PROCESS_COLOUR";
                                break;
                            case "M":
                                param.data.NAME = "ZPKG_SEC_PLAST_PROCESS_COLOUR";
                                break;
                            default:
