...
{
    [Route("api/lov/pa/shcclaim")]
    public class SymbolNutrientHealthClaimController : ApiController
    {
        // GET api/<controller>
        public SAP_M_CHARACTERISTIC_RESULT Get([FromUri]SAP_M_CHARACTERISTIC_REQUEST param)
        {
            return Helper.QueryByName("ZPKG_SEC_SYMBOL", param);
            ...
            //    }
            //    param.data.NAME = "ZPKG_SEC_SYMBOL";
