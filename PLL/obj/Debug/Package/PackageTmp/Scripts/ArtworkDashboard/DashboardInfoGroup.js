...
$(document).ready(function () {
    ...
    if ($(".cls_li_igird_infogroup").is(':visible')) {
        ...
        $("a[href='#view_igrid_infogroup_view']").on('shown.bs.tab', function (e) {
    ...
    $("#view_infogroup .cls_btn_excel_igrid").click(function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                if (res.status == 'S') {
                    ...
                    $("#view_infogroup .cls_btn_search_igrid_view").click();
                }
            }
        });
    };
