...
namespace DAL.Model
{
    public partial class ART_WF_ARTWORK_PROCESS_AFTER_CUSTOMER_GM_QC_2 : ART_WF_ARTWORK_PROCESS_AFTER_CUSTOMER_GM_QC
    {
        public ART_WF_ARTWORK_PROCESS_2 PROCESS { get; set; }
        public bool ENDTASKFORM { get; set; }
        public int ARTWORK_ITEM_ID { get; set; }
        public string ACTION_NAME { get; set; }
        public string ACTION_NAME_SENDER { get; set; }
        public string PREV_STEP { get; set; }
        public string COMMENT_BY_QC { get; set; }
        public string REASON_BY_QC { get; set; }
        public string REASON_BY_OTHER { get; set; }
        public DateTime CREATE_DATE_BY_QC { get; set; }
    ...
    public class ART_WF_ARTWORK_PROCESS_AFTER_CUSTOMER_GM_QC_2_METADATA
    {

    }

    public class ART_WF_ARTWORK_PROCESS_AFTER_CUSTOMER_GM_QC_REQUEST : REQUEST_MODEL
    {
        public ART_WF_ARTWORK_PROCESS_AFTER_CUSTOMER_GM_QC_2 data { get; set; }
    }

    public class ART_WF_ARTWORK_PROCESS_AFTER_CUSTOMER_GM_QC_REQUEST_LIST : REQUEST_MODEL
    {
        public List<ART_WF_ARTWORK_PROCESS_AFTER_CUSTOMER_GM_QC_2> data { get; set; }
    }

    public class ART_WF_ARTWORK_PROCESS_AFTER_CUSTOMER_GM_QC_RESULT : RESULT_MODEL
    {
        public List<ART_WF_ARTWORK_PROCESS_AFTER_CUSTOMER_GM_QC_2> data { get; set; }
    }
}
