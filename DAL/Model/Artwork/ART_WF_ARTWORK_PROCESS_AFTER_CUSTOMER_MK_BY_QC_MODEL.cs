...
namespace DAL.Model
{
    public partial class ART_WF_ARTWORK_PROCESS_AFTER_CUSTOMER_MK_BY_QC_2 : ART_WF_ARTWORK_PROCESS_AFTER_CUSTOMER_MK_BY_QC
    {
        ...
        public string ACTION_NAME_BY_OTHER { get; set; }
        public string APPROVE_BY_OTHER { get; set; }
        public string COMMENT_BY_PA { get; set; }
        public string REASON_BY_PA { get; set; }
        public string APPROVE_BY_QC { get; set; }
        public string REASON_BY_OTHER { get; set; }
        public string SEND_TO_CUSTOMER_TYPE { get; set; }
        public string PREV_STEP_DISPLAY { get; set; }
        public string PREV_STEP_SHOW { get; set; }
        public DateTime CREATE_DATE_BY_OTHER { get; set; }
    ...
    public class ART_WF_ARTWORK_PROCESS_AFTER_CUSTOMER_MK_BY_QC_2_METADATA
    {

    }

    public class ART_WF_ARTWORK_PROCESS_AFTER_CUSTOMER_MK_BY_QC_REQUEST : REQUEST_MODEL
    {
        public ART_WF_ARTWORK_PROCESS_AFTER_CUSTOMER_MK_BY_QC_2 data { get; set; }
    }

    public class ART_WF_ARTWORK_PROCESS_AFTER_CUSTOMER_MK_BY_QC_RESULT : RESULT_MODEL
    {
        public List<ART_WF_ARTWORK_PROCESS_AFTER_CUSTOMER_MK_BY_QC_2> data { get; set; }
    }
}
