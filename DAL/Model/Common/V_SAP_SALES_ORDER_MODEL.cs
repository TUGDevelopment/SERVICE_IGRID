...
namespace DAL.Model
{
    public partial class V_SAP_SALES_ORDER_2 : V_SAP_SALES_ORDER
    {
    ...
    public class V_SAP_SALES_ORDER_REQUEST : REQUEST_MODEL
    {
        public V_SAP_SALES_ORDER_2 data { get; set; }
    }

    public class V_SAP_SALES_ORDER_RESULT : RESULT_MODEL
    {
        public List<V_SAP_SALES_ORDER_2> data { get; set; }
    }
}
