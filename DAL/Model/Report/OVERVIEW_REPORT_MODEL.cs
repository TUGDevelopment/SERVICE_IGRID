...
namespace DAL.Model
{
   public partial class OVERVIEW_REPORT
    {
    ...
    public class OVERVIEW_REPORT_REQUEST : REQUEST_MODEL
    {
        public string name { get; set; }
        public string condition { get; set; }
        public string Keyword { get; set; }
        public OVERVIEW_REPORT data { get; set; }
    }

    public class OVERVIEW_REPORT_REQUEST_LIST : REQUEST_MODEL
    {
        public List<OVERVIEW_REPORT> data { get; set; }
    }

    public class OVERVIEW_REPORT_RESULT : RESULT_MODEL
    {
        public List<OVERVIEW_REPORT> data { get; set; }
    }
}
