...
namespace DAL.Model
{
    ...
    [MetadataType(typeof(ART_WF_MOCKUP_CHECK_LIST_COUNTRY_2_METADATA))]
    public partial class ART_WF_MOCKUP_CHECK_LIST_COUNTRY_2 : ART_WF_MOCKUP_CHECK_LIST_COUNTRY
    {
        public string COUNTRY_DISPLAY_TXT { get; set; }
    }

    public class ART_WF_MOCKUP_CHECK_LIST_COUNTRY_2_METADATA
    {
