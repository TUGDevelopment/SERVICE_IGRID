...
//{
//    public class RDByPGHelper
//    {
//        public static ART_WF_MOCKUP_PROCESS_RD_BY_PG_RESULT GetRDByPG(ART_WF_MOCKUP_PROCESS_RD_BY_PG_REQUEST param)
//        {
//            ART_WF_MOCKUP_PROCESS_RD_BY_PG_RESULT Results = new ART_WF_MOCKUP_PROCESS_RD_BY_PG_RESULT();

//            try
//            {
//                if (param == null || param.data == null)
//                {
//                    Results.data = MapperServices.ART_WF_MOCKUP_PROCESS_RD_BY_PG(ART_WF_MOCKUP_PROCESS_RD_BY_PG_SERVICE.GetAll());
//                }
//                else
//                {
//                    Results.data = MapperServices.ART_WF_MOCKUP_PROCESS_RD_BY_PG(ART_WF_MOCKUP_PROCESS_RD_BY_PG_SERVICE.GetByItemContain(MapperServices.ART_WF_MOCKUP_PROCESS_RD_BY_PG(param.data)));
//                }
...
//        public static ART_WF_MOCKUP_PROCESS_RD_BY_PG_RESULT SaveRDByPG(ART_WF_MOCKUP_PROCESS_RD_BY_PG_REQUEST param)
//        {
//            ART_WF_MOCKUP_PROCESS_RD_BY_PG_RESULT Results = new ART_WF_MOCKUP_PROCESS_RD_BY_PG_RESULT();
//            try
//            {
...
//                        {
//                            processResults = SaveProcessRDByPG(param, context);
//                        }

//                        var rdData = MapperServices.ART_WF_MOCKUP_PROCESS_RD_BY_PG(param.data);

//                        if (processResults != null && processResults.data != null && processResults.data.Count > 0)
//                        {
//                            rdData.MOCKUP_SUB_ID = processResults.data[0].MOCKUP_SUB_ID;
//                        }

//                        ART_WF_MOCKUP_PROCESS_RD_BY_PG_SERVICE.SaveOrUpdate(rdData, context);

//                        Results.data = new List<ART_WF_MOCKUP_PROCESS_RD_BY_PG_2>();
//                        ART_WF_MOCKUP_PROCESS_RD_BY_PG_2 item = new ART_WF_MOCKUP_PROCESS_RD_BY_PG_2();
//                        List<ART_WF_MOCKUP_PROCESS_RD_BY_PG_2> listItem = new List<ART_WF_MOCKUP_PROCESS_RD_BY_PG_2>();

//                        item.MOCKUP_PROCESS_RD_BY_PG_ID = rdData.MOCKUP_PROCESS_RD_BY_PG_ID;
//                        listItem.Add(item);
...
//        private static ART_WF_MOCKUP_PROCESS_RESULT SaveProcessRDByPG(ART_WF_MOCKUP_PROCESS_RD_BY_PG_REQUEST param, ARTWORKEntities context)
//        {
