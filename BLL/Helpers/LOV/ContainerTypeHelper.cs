...
namespace BLL.Helpers
{
    ...
    {
        public static SAP_M_CHARACTERISTIC_RESULT GetContainerType(SAP_M_CHARACTERISTIC_REQUEST param)
        {
                ...
                using (var context = new ARTWORKEntities())
                {
                    using (CNService.IsolationLevel(context))
                    {
                        if (param == null || param.data == null)
                        {
                            ...
                            characteristic.NAME = "ZPKG_SEC_CONTAINER_TYPE";
                        ...
                        {
                            param.data.NAME = "ZPKG_SEC_CONTAINER_TYPE";
