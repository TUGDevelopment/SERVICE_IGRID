...
{
    public class PrimaryTypeHelper
    {
        public static SAP_M_CHARACTERISTIC_RESULT GetPrimaryType(SAP_M_CHARACTERISTIC_REQUEST param)
        {
                ...
                using (var context = new ARTWORKEntities())
                {
                    using (CNService.IsolationLevel(context))
                    {
                        if (param == null || param.data == null)
                        {
                            ...
                            characteristic.NAME = "ZPKG_SEC_PRIMARY_TYPE";
                        ...
                        {
                            param.data.NAME = "ZPKG_SEC_PRIMARY_TYPE";
