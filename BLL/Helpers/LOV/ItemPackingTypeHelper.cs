...
{
    public class ItemPackingTypeHelper
    {
        public static SAP_M_CHARACTERISTIC_RESULT GetPackType(SAP_M_CHARACTERISTIC_REQUEST param)
        {
            ...
            try
            {
                using (var context = new ARTWORKEntities())
                {
                    using (CNService.IsolationLevel(context))
                    {
                        ...
                        {
                            param.data.NAME = "ZPKG_SEC_GROUP";
        ...
        public static SAP_M_CHARACTERISTIC_RESULT GetPackType(SAP_M_CHARACTERISTIC_REQUEST param, ARTWORKEntities context)
        {
            SAP_M_CHARACTERISTIC_RESULT Results = new SAP_M_CHARACTERISTIC_RESULT();
