...
{
    public class ItemCoatingHelper
    {
        public static SAP_M_CHARACTERISTIC_ITEM_2_RESULT GetCoating(SAP_M_CHARACTERISTIC_ITEM_2_REQUEST param)
        {
