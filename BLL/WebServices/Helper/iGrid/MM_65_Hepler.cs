            ...
            if (param.data.ARTWORK_SUB_ID > 0)
            {
                try
                {
                    using (var context = new ARTWORKEntities())
                    {
                        ...
                        string msgError = "Please select required field in PA Data before request material or update material.<br>{0}";
                        string msg = "";
                        ...
                        if (processPA.MATERIAL_GROUP_ID == null)
                        {
                            ...
                            msg += "- Required field cannot be blank.(Material group)"; 
                        }
                        else
                        {
                                ...
                                switch (matGroupCode.ToUpper())
                                {
                                    case "K":
                                        if (processPA.STYLE_OF_PRINTING_ID == null)
                                        {
                                            ...
                                            if (msg.Length > 0) msg += "<br>";
                                            msg += "- Required field cannot be blank.(Style of printing)";
                                        }
                                        else if (processPA.STYLE_OF_PRINTING_ID == -1) //else if (processPA.STYLE_OF_PRINTING_ID == -1 && String.IsNullOrEmpty(processPA.STYLE_OF_PRINTING_OTHER))  //IGRID_REIM_PA
                                        {
                                            //if (msg.Length > 0) msg += ", ";
                                            //msg += "Style of printing is not other"; //IGRID_REIM_PA
                                            if (msg.Length > 0) msg += "<br>";
                                            msg += "- Data cannot be ''other''.(Style of printing)"; //IGRID_REIM_PA
                                        }
                                        break;
                                    case "L":
                                        //nothing
                                    ...
                                    case "J":
                                        ...
                                        if (processPA.DIRECTION_OF_STICKER_ID == null)
                                        {
                                            ...
                                            if (msg.Length > 0) msg += "<br>";
                                            msg += "- Required field cannot be blank.(Direction of sticker)";
                                        }
                                        else if (processPA.DIRECTION_OF_STICKER_ID == -1 && String.IsNullOrEmpty(processPA.DIRECTION_OF_STICKER_OTHER))
                                        {
                                            ...
                                            //msg += "Direction of sticker";
                                            if (msg.Length > 0) msg += "<br>";
                                            msg += "- Data cannot be ''other''.(Direction of sticker)"; //IGRID_REIM_PA
                                        }
                                    ...
                                    default:
                                        if (processPA.TWO_P_ID == null)
                                        {
                                            ...
                                            if (msg.Length > 0) msg += "<br>";
                                            msg += "- Required field cannot be blank.(Packing style or Pack size)";
                                        ...
                                        else if (processPA.TWO_P_ID != null && processPA.TWO_P_ID == -1)
                                        {
                                            //IGRID_REIM_PA
                                            //if (msg.Length > 0) msg += ", ";
                                            //msg += "Packing style is not other";
                                            if (msg.Length > 0) msg += "<br>";
                                            msg += "- Data cannot be ''other''.(Packing style)"; //IGRID_REIM_PA
                                            ...
                                            if (processPA.PACK_SIZE_ID == null)
                                            {
                                                ...
                                                //msg += "Pack size";
                                                if (msg.Length > 0) msg += "<br>";
                                                msg += "- Required field cannot be blank.(Pack size)";
                                            }
                                            else if (processPA.TWO_P_ID == -1 && processPA.PACK_SIZE_ID == -1) //else if (processPA.TWO_P_ID == -1 && processPA.PACK_SIZE_ID == -1 && String.IsNullOrEmpty(processPA.PACK_SIZE_OTHER)) //IGRID_REIM_PA
                                            {
                                                //if (msg.Length > 0) msg += ", ";
                                                //msg += "Pack size is not other"; //IGRID_REIM_PA
                                                if (msg.Length > 0) msg += "<br>";
                                                msg += "- Data cannot be ''other''.(Pack size)"; //IGRID_REIM_PA
                                            }
                                        }
                        ...
                        //by aof 202306 for CR#IGRID_REIM---- require Type of
                        if (processPA.TYPE_OF_ID == null)
                        {
                            //if (msg.Length > 0) msg += ", ";
                            //msg += "Type of";
                            if (msg.Length > 0) msg += "<br>";
                            msg += "- Required field cannot be blank.(Type of)";
                        } else if (processPA.TYPE_OF_ID ==-1 &&  string.IsNullOrEmpty(processPA.TYPE_OF_OTHER))
                        {
                            //if (msg.Length > 0) msg += ", ";
                            //msg += "Type of";
                            if (msg.Length > 0) msg += "<br>";
                            msg += "- Data is ''other'' cannot be blank.(Type of)";
                        }




                        if (processPA.TYPE_OF_2_ID == null)
                        {
                            var matGroupCode = SAP_M_CHARACTERISTIC_SERVICE.GetByCHARACTERISTIC_ID(processPA.MATERIAL_GROUP_ID, context).VALUE;
                            if (matGroupCode != null)
                            {
                                switch (matGroupCode.ToUpper())
                                {
                                    ...
                                    case "D":
                                        if (msg.Length > 0) msg += "<br>";
                                        msg += "- Required field cannot be blank.(Type of 2)";
                                        break;
                                }
                        ...
                        var product = (from p in context.ART_WF_ARTWORK_PROCESS_PA_PRODUCT
                                       where p.ARTWORK_SUB_ID == process.ARTWORK_SUB_ID && p.ARTWORK_SUB_PA_ID == processPA.ARTWORK_SUB_PA_ID
                                       select p).ToList();

                        var process_pa = (from p in context.ART_WF_ARTWORK_PROCESS_PA
                                          where p.ARTWORK_SUB_ID == process.ARTWORK_SUB_ID
                                          select p).FirstOrDefault();


                        if ((product != null && product.Count > 0) || (process_pa != null && process_pa.PRODUCT_CODE_ID > 0))
                        {
                            //string 
                        }
                        else
                        {
                            var f_found = false;
                            var productOther = (from p in context.ART_WF_ARTWORK_PROCESS_PA_PRODUCT_OTHER
                                                where p.ARTWORK_SUB_ID == process.ARTWORK_SUB_ID && p.ARTWORK_SUB_PA_ID == processPA.ARTWORK_SUB_PA_ID
                                                select p).ToList();
                            ...
                            if (productOther != null && productOther.Count > 0)
                            {
                                ...
                                foreach (var p in productOther)
                                {
                                    if (p.PRODUCT_CODE.Length >= 18)
                                    {
                                        var tempProduct = p.PRODUCT_CODE.Substring(0, 18);
                        ...
                        if (processPA.THREE_P_ID == null)
                        {
                            ...
                            //msg += "Primary size";
                            if (msg.Length > 0) msg += "<br>";
                            msg += "- Required field cannot be blank.(Primary size)";
                        }
                        else if (processPA.THREE_P_ID == -1)
                        {
                            //IGRID_REIM_PA
                            //if (msg.Length > 0) msg += ", ";
                            //msg += "Primary size is not other";
                            if (msg.Length > 0) msg += "<br>";
                            msg += "- Data cannot be ''other''.(Primary size)"; //IGRID_REIM_PA
                            ...
                            if (processPA.CONTAINER_TYPE_ID == null)
                            {
                                ...
                                //msg += "Container type";
                                if (msg.Length > 0) msg += "<br>";
                                msg += "- Required field cannot be blank.(Container type)";
                            }
                            else if (processPA.THREE_P_ID == -1 && processPA.CONTAINER_TYPE_ID == -1) // else if (processPA.THREE_P_ID == -1 && processPA.CONTAINER_TYPE_ID == -1 && String.IsNullOrEmpty(processPA.CONTAINER_TYPE_OTHER)) //IGRID_REIM_PA
                            {
                                //if (msg.Length > 0) msg += ", ";
                                //msg += "Container type is not other"; //IGRID_REIM_PA
                                if (msg.Length > 0) msg += "<br>";
                                msg += "- Data cannot be ''other''.(Container type)"; //IGRID_REIM_PA
                            }
                            ...
                            if (processPA.LID_TYPE_ID == null)
                            {
                                ...
                                //msg += "Lid type";
                                if (msg.Length > 0) msg += "<br>";
                                msg += "- Required field cannot be blank.(Lid type)";
                            }
                            else if (processPA.THREE_P_ID == -1 && processPA.LID_TYPE_ID == -1) //else if (processPA.THREE_P_ID == -1 && processPA.LID_TYPE_ID == -1 && String.IsNullOrEmpty(processPA.LID_TYPE_OTHER)) //IGRID_REIM_PA
                            {
                                //if (msg.Length > 0) msg += ", ";
                                //msg += "Lid type is not other"; //IGRID_REIM_PA
                                if (msg.Length > 0) msg += "<br>";
                                msg += "- Data cannot be ''other''.(Lid type)"; //IGRID_REIM_PA
                            }
                        ...
                        if (processPA.PLANT_REGISTERED_ID == null)
                        {
                            if (msg.Length > 0) msg += "<br>";
                            msg += "- Required field cannot be blank.(Plant registered No.)";
                        }


                        var faozone = (from p in context.ART_WF_ARTWORK_PROCESS_PA_FAO_ZONE
                                               where p.ARTWORK_SUB_ID == process.ARTWORK_SUB_ID && p.ARTWORK_SUB_PA_ID == processPA.ARTWORK_SUB_PA_ID
                                               select p).ToList();
                        if (faozone != null && faozone.Count > 0)
                        {
                            //string 
                        }
                        else
                        {
                            if (msg.Length > 0) msg += "<br>";
                            msg += "- Required field cannot be blank.(FAO Zone.)";
                        }



                        if (processPA.PMS_COLOUR_ID == null)
                        {
                            if (msg.Length > 0) msg += "<br>";
                            msg += "- Required field cannot be blank.(PMS Colour.)";
                        }



                        if (processPA.COMPANY_ADDRESS_ID == null)
                        {
                            if (msg.Length > 0) msg += "<br>";
                            msg += "- Required field cannot be blank.(Company name/Address.)";
                        }


                        var catchingAreas = (from p in context.ART_WF_ARTWORK_PROCESS_PA_CATCHING_AREA
                                               where p.ARTWORK_SUB_ID == process.ARTWORK_SUB_ID && p.ARTWORK_SUB_PA_ID == processPA.ARTWORK_SUB_PA_ID
                                               select p).ToList();
                        ...
                        {
                            //Results.status = "E";
                            //Results.msg = string.Format(msgError, "Catching method");
                            //return Results;
                            //if (msg.Length > 0) msg += ", ";
                            //msg += "Catching method";
                            if (msg.Length > 0) msg += "<br>";
                            msg += "- Required field cannot be blank.(Catching area)";
                        }


                        if (processPA.PROCESS_COLOUR_ID == null)
                        {
                            if (msg.Length > 0) msg += "<br>";
                            msg += "- Required field cannot be blank.(Process colour.)";
                        }


                        //start by aof 202306 for CR#IGRID_REIM---- require SYMBOL
                        var symbols = (from p in context.ART_WF_ARTWORK_PROCESS_PA_SYMBOL
                                       where p.ARTWORK_SUB_ID == processPA.ARTWORK_SUB_ID
                        ...
                        {
                            var tempMsg = "";
                            var constants = (from p in context.ART_M_CONSTANT
                                             where p.VARIABLE_NAME == "ZPKG_SEC_SYMBOL" && p.PROGRAM_NAME == "TASKFORMPA" && p.IS_ACTIVE == "X"
                                             select p).ToList();
                            if (constants != null && constants.Count > 0)
                            {
                                var chars = (from p in context.SAP_M_CHARACTERISTIC
                                             where p.NAME == "ZPKG_SEC_SYMBOL" & p.IS_ACTIVE == "X"
                                             select p).ToList();

                                var grpRequires = constants.Select(s => s.FUNCAREA).Distinct().ToList();
                                var processPAS_Symbol_IDs = symbols.Select(s => s.SYMBOL_ID).Distinct().ToList();  // get list char_id from process_pa_symbols
                                foreach (var grp in grpRequires)
                                {
                                    var option = constants.Where(w => w.FUNCAREA == grp).Select(s => s.OPTION).FirstOrDefault();


                                    if (grp == "Symbol")
                                    {
                                        var constaintOptionEQs = constants.Where(w => w.OPTION == "EQ" && w.FUNCAREA != grp).Select(s => s.LOWVALUE).Distinct().ToList(); // get list char_value from constaint
                                        var tempChars = chars.Where(w => processPAS_Symbol_IDs.Contains(w.CHARACTERISTIC_ID) && !constaintOptionEQs.Contains(w.VALUE)).Distinct().ToList();

                                        if (tempChars.Count() == 0)
                                        {
                                            if (tempMsg.Length > 0) tempMsg += ", ";
                                            tempMsg += grp;
                                        }
                                    }
                                    else
                                    {
                                        ...
                                        var constaintOptionEQs = constants.Where(w => w.FUNCAREA == grp).Select(s => s.LOWVALUE).Distinct().ToList(); // get list char_value from constaint
                                        var tempChars = chars.Where(w => processPAS_Symbol_IDs.Contains(w.CHARACTERISTIC_ID) && constaintOptionEQs.Contains(w.VALUE)).Distinct().ToList();
                                        if (tempChars.Count() == 0)
                                        {
                                            if (tempMsg.Length > 0) tempMsg += ", ";
                                        ...
                                        //    var constaintOptionEQs = constants.Where(w => w.OPTION == "EQ").Select(s => s.LOWVALUE).Distinct().ToList(); // get list char_value from constaint
                                        //    var tempChars = chars.Where(w => processPAS_Symbol_IDs.Contains(w.CHARACTERISTIC_ID) && !constaintOptionEQs.Contains(w.VALUE)).Distinct().ToList();
                                ...
                                {
                                    if (msg.Length > 0) msg += "<br>";
                                    msg += "- Required field cannot be blank.(" + tempMsg + ")";
                                }
                            }
                        }
                        else
                        {
                            //if (msg.Length > 0) msg += ", ";
                            //msg += "Symbol/Nutrient/Health claim";
                            if (msg.Length > 0) msg += "<br>";
                            msg += "- Required field cannot be blank.(Symbol/Nutrient/Health claim)";
                        }
                        ...
                        //end by aof 202306 for CR#IGRID_REIM---- require SYMBOL

                        if (processPA.CATCHING_PERIOD_ID  == null)
                        {
                            if (msg.Length > 0) msg += "<br>";
                            msg += "- Required field cannot be blank.(Catching period/Date.)";
                        ...
                        if (processPA.TOTAL_COLOUR_ID == null)
                        {
                            ...
                            //msg += "Total colour";
                            if (msg.Length > 0) msg += "<br>";
                            msg += "- Required field cannot be blank.(Total colour)";
                        }
                        else if (processPA.TOTAL_COLOUR_ID == -1) //else if (processPA.TOTAL_COLOUR_ID == -1 && String.IsNullOrEmpty(processPA.TOTAL_COLOUR_OTHER)) //IGRID_REIM_PA
                        {
                            //if (msg.Length > 0) msg += ", ";
                            //msg += "Total colour in not other";  //IGRID_REIM_PA
                            if (msg.Length > 0) msg += "<br>";
                            msg += "- Data cannot be ''other''.(Total colour)"; //IGRID_REIM_PA
                        }


                        //by aof 202306 for CR#IGRID_REIM---- require Catching Method

                        var catchingMethods = (from p in context.ART_WF_ARTWORK_PROCESS_PA_CATCHING_METHOD
                                               where p.ARTWORK_SUB_ID == process.ARTWORK_SUB_ID && p.ARTWORK_SUB_PA_ID == processPA.ARTWORK_SUB_PA_ID
                                               select p).ToList();
                        ...
                        else
                        {
                            ...
                            //msg += "Catching method";
                            if (msg.Length > 0) msg += "<br>";
                            msg += "- Required field cannot be blank.(Catching method)";
                        }
                        ...
                        {
                            if (msg.Length > 0) msg += "<br>";
                            msg += "- Required field cannot be blank.(Plant)";
                            //Results.status = "E";
                        ...
                        //by aof 202306 for CR#IGRID_REIM---- require SCIENTIFIC_NAME_ID
                        if (processPA.SCIENTIFIC_NAME_ID == null)
                        {
                            //if (msg.Length > 0) msg += ", ";
                            //msg += "Scientific name";
                            if (msg.Length > 0) msg += "<br>";
                            msg += "- Required field cannot be blank.(Scientific name)";
                        }
                        else if (processPA.SCIENTIFIC_NAME_ID == -1 && string.IsNullOrEmpty(processPA.SCIENTIFIC_NAME_OTHER))
                        {
                            //if (msg.Length > 0) msg += ", ";
                            //msg += "Scientific name";
                            if (msg.Length > 0) msg += "<br>";
                            msg += "- Data is ''other'' cannot be blank.(Scientific name)";
                        }
                        //by aof 202306 for CR#IGRID_REIM---- 



                        //by aof 202306 for CR#IGRID_REIM---- require SPECIE_ID
                        if (processPA.SPECIE_ID == null)
                        {
                            //if (msg.Length > 0) msg += ", ";
                            //msg += "Specie";
                            if (msg.Length > 0) msg += "<br>";
                            msg += "- Required field cannot be blank.(Specie)";
                        }
                        else if (processPA.SPECIE_ID == -1 && string.IsNullOrEmpty(processPA.SPECIE_OTHER))
                        {
                            //if (msg.Length > 0) msg += ", ";
                            //msg += "Specie";
                            if (msg.Length > 0) msg += "<br>";
                            msg += "- Data is ''other'' cannot be blank.(Specie)";
                        }
                        //by aof 202306 for CR#IGRID_REIM---- 
                        ...
                        if (processPA.PRINTING_STYLE_OF_PRIMARY_ID != null && processPA.PRINTING_STYLE_OF_PRIMARY_ID != -1)
                        {
                        ...
                        if (processPA.PRINTING_STYLE_OF_SECONDARY_ID != null && processPA.PRINTING_STYLE_OF_SECONDARY_ID != -1)
                        {
            ...
            if (param.data.ARTWORK_SUB_ID > 0)
            {
                try
                {
                    using (var context = new ARTWORKEntities())
                    {
                        ...
                        artworkObj.Time = timeStr;
                        artworkObj.RecordType = param.data.RECORD_TYPE;
                        artworkObj.MaterialDescription = processPA.MATERIAL_DESCRIPTION;
                        if (param.data.RECORD_TYPE != "I" && !String.IsNullOrEmpty(processPA.MATERIAL_NO))
                        {
                            artworkObj.MaterialNumber = processPA.MATERIAL_NO;
                        ...
                        artworkObj.SOitem = "";
                        artworkObj.SOPlant = "";
                        artworkObj.PICMKT = processPA.PIC_MKT;
                        artworkObj.Destination = "";
                        artworkObj.RemarkNoteofPA = processPA.NOTE_OF_PA;
                        artworkObj.FinalInfoGroup = processPA.FIRST_INFOGROUP_OTHER;
                        artworkObj.RemarkNoteofPG = CNService.RemoveHTMLTag(noteOfPG);
                    ...
                    try
                    {
                        ...
                        else if (iColumn == "ZPKG_SEC_PRODUCT_CODE")
                        {
                            ...
                            var additionalProductOther = (from d in context.ART_WF_ARTWORK_PROCESS_PA_PRODUCT_OTHER
                                                          where d.ARTWORK_SUB_PA_ID == dataPA.ARTWORK_SUB_PA_ID && ((d.PRODUCT_CODE.StartsWith("3") && d.PRODUCT_CODE.Length==18)||(
                                                          d.PRODUCT_CODE.StartsWith("3W") && d.PRODUCT_CODE.Length == 12) || (d.PRODUCT_CODE.StartsWith("3V") && d.PRODUCT_CODE.Length == 12)
                                                          || (d.PRODUCT_CODE.StartsWith("3V") && d.PRODUCT_CODE.Length == 9) || (d.PRODUCT_CODE.StartsWith("2") && d.PRODUCT_CODE.Length == 18))
                                                          select d).ToList();
